...
<div class="container-fluid" style="overflow-x: hidden">
    <div class="row posts">
        <div class="col-md-2 posts-left">
            <div class="card pt-5">
                <form action="search" enctype="multipart/form-data" method="POST" class="pb-5">

                    <button type="submit" name="today" value="today" class="btn btn-primary">Today's</button>
                    @csrf
                </form>
                <form action="search" enctype="multipart/form-data" method="POST" class="pb-5">
        ...
        <div class="col-md-10 posts-right p-5 " style="">
            @isset($search_posts)
