...
2 8 -682 698 -692 698 -4 0 -22 -15 -40 -34z"/>
                    ...
                    <div class="collapse navbar-collapse" id="navcol-1">
                        ...
                        @if (Route::has('login'))
                            <div class="top-right links " style="position:absolute;right: 3%;">
                                @auth
                                    <a href="{{ url('/home') }}">Home</a>
                                @else
                                    <span class=" mr-2"> <a class="login-button   "  href="{{ route('login') }}">Log In  </a> </span>

                                    @if (Route::has('register'))
                                        <a class="btn btn-outline-light sign " role="button" href="{{ route('register') }}">Sign Up</a>
                                    @endif
                                @endauth
                            </div>
                        @endif
